...
public class BandCommentListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bandCommentBeanArrayList.add(new BandCommentBean("00000","BV1U8411t73A","这是一条评论",BandCommentBean.BAND_TYPE_SHADOW_BAN,BandCommentBean.AREA_VIDEO,new Date()));
        bandCommentBeanArrayList.add(new BandCommentBean("00000","BV1U8411t73A","这是一条评论",BandCommentBean.BAND_TYPE_QUICK_DELETE,BandCommentBean.AREA_VIDEO,new Date()));
        bandCommentBeanArrayList.add(new BandCommentBean("00000","BV1U8411t73A","这是一条评论",BandCommentBean.BAND_TYPE_SENSITIVE,BandCommentBean.AREA_VIDEO,new Date()));
        */
